...
Deberás de abordar un problema de analítica de datos, 1) elegir dataset, 2) definir tarea, 3) ejecutar. El resultado ha de ser un notebook ejecutable que contenga, preprocesado (latent semantics), varios algoritmos de clasificación o regresión, análisis de rendimiento y curvas de aprendizaje.
